    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Take a closer look at our modern hospital, experienced medical
            professionals, advanced laboratories, and the compassionate care we
            provide every day.
          </motion.p>
        </motion.section>
            ...
            <div className="grid items-center gap-10 lg:grid-cols-2">
              ...
              <div>
                ...
                <p className="mt-6 text-lg leading-8 text-slate-600">
                  ...
                  medical technology, creating a comfortable and professional
            ...
            <div className="grid items-center gap-10 lg:grid-cols-2">
              ...
              <div>
                ...
                <p className="mt-6 max-w-xl text-lg leading-8 text-blue-100">
                  Discover modern healthcare facilities, experienced doctors,
                  advanced medical equipment, and compassionate patient care
                  designed to keep your family healthy.
                </p>
              </div>
          ...
          >
            {[
              ...
              >
                ...
                <p className="mt-4 leading-8 text-slate-600">{feature.desc}</p>
              </motion.div>
            ))}
          </motion.section>
        </div>
