...
const BookAppointment = () => {
  return (
    <section className="relative overflow-hidden bg-linear-to-b from-white via-cyan-50/40 to-white py-20">
      <Helmet>
        <title>Book Appoinment | MediCare</title>
          ...
          >
            ...
            <form className="space-y-6">
              ...
              <div className="grid gap-6 md:grid-cols-2">
                ...
                {/* Department */}
                <div className="relative">
                  <select className="h-14 w-full appearance-none rounded-2xl border border-slate-200 bg-slate-50 px-5 pr-12 outline-none transition-all duration-300 focus:border-cyan-500 focus:bg-white focus:ring-4 focus:ring-cyan-100">
          ...
          >
            ...
            >
              ...
              <div className="space-y-5 p-8">
                ...
                <div className="flex items-center justify-between rounded-2xl bg-cyan-50 p-5">
                  ...
                  <span className="font-semibold text-cyan-600">50+</span>
                </div>
                ...
                <div className="mt-8 grid grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <p className="mt-2 text-sm text-slate-500">Success Rate</p>
                  </motion.div>
                  ...
                  >
                    ...
                    <p className="mt-2 text-sm text-slate-500">Specialists</p>
                  </motion.div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-bold text-slate-900">Trusted Care</h4>
