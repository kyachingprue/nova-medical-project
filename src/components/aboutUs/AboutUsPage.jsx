...
const AboutUsPage = () => {
  return (
    <section className="bg-white">
      <main className="max-w-3xl md:max-w-5xl lg:max-w-7xl mx-auto py-4 md:py-16 lg:py-24 px-4">
        <div className="flex flex-col md:flex-row gap-5 items-center">
          ...
          <div className="pl-6">
            ...
            <h3 className="text-3xl md:text-5xl font-bold text-black py-3">
          ...
          <div className="bg-blue-800 rounded-2xl p-3">
            <h3 className="text-3xl md:text-4xl font-bold text-white py-3">
